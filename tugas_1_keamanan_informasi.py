# -*- coding: utf-8 -*-
"""Tugas 1_Keamanan Informasi.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1TFwjqu-ErHmUQ86DTIiBgR16Fv-jn0lf
"""
...
if __name__ == "__main__":
    print("Contoh Tutorial:")
    print("1. Kunci: '133457799BBCDFF1'")
    print("2. Plain Text: '0123456789ABCDEF'")

    key_example = '133457799BBCDFF1'
    plain_text_example = '0123456789ABCDEF'

    key_bits_example = hex_to_bit_array(key_example)
    round_keys_example = key_generation(key_bits_example)

    plain_bits_example = hex_to_bit_array(plain_text_example)
    cipher_bits_example = des_encryption(plain_bits_example, round_keys_example)
    cipher_text_example = bit_array_to_hex(cipher_bits_example)
    print(f"\nTeks terenkripsi dari contoh: {cipher_text_example}")

    decrypted_bits_example = des_decryption(cipher_bits_example, round_keys_example)
    decrypted_text_example = bit_array_to_hex(decrypted_bits_example)
    print(f"Teks setelah dekripsi dari contoh: {decrypted_text_example}")

    print("\nSekarang silakan masukkan input Anda sendiri:")

    key = input("Masukkan kunci dalam format heksadesimal (16 karakter): ")
    plain_text = input("Masukkan plaintext dalam format heksadesimal (16 karakter): ")

    key_bits = hex_to_bit_array(key)
    round_keys = key_generation(key_bits)

    plain_bits = hex_to_bit_array(plain_text)
    ...
    decrypted_bits = des_decryption(cipher_bits, round_keys)
    decrypted_text = bit_array_to_hex(decrypted_bits)
